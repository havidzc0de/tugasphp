    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
       ...
       <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="view-all.php"><i class="fa fa-list "></i> List Category</a></li>
          <li><a href="add.php"><i class="fa fa-plus-square"></i> Add Category</a></li>
          <li><a href="edit.php"><i class="fa fa-edit"></i> Edit Category</a></li>
        </ul>
      </li>
    </ul>
  </section>
  ...
  <section class="content">
    ...
    <!-- Main row -->
        ...
        <form method="POST">
          <div class="row">
            <div class="col-md-4">
              <input name="namecategory" type="text" class="form-control" placeholder="Category Name">
            </div>
            <div class="col-md-6">
              <input name="desccategory" type="text" class="form-control" placeholder="Description">
            </div>
            <div class="custom-file col-md-2">
             <!--  <input type="file" class="custom-file-input" id="validatedCustomFile" required> -->
            </div>
             <div class="col-md-3">
                <button name="addcategory" class="btn btn-primary" type="submit">Submit</button>
            </div>
          </div>
        </form>
...
$koneksi->setAttribute(PDO::ATRR_ERRMODE,PDO::ERRMODE_EXCEPTION);

if (isset($_POST['addcategory'])) {
  $namecategory = $_POST['namecategory'];
  $desccategory = $_POST['desccategory'];

  $query ="INSERT INTO categories(CategoryName,Description)VALUES('$namecategory','$desccategory')";
